...
Sol was developed using Visual Studio 2022. If you wish to run Sol via the Visual Studio solution debugger, please ensure SDL2.dll (provided in the root directory for convenience, or available in the release build v.1.0 from the sidebar) copied and pasted directly into the appropriate directory (or installed to PATH) outlined below:
